...
# ------------- USER INPUTS -------------
# Xavier (BR-DWGD) output from step 02
ZETA_CSV      = r'G:/My Drive/xavier_bias_pairs/zeta_per_station.csv'  # <- Xavier ζ table
...
OUT_TIF       = r'G:/My Drive/xavier_bias_pairs/zeta_map_010deg.tif'   # <- Xavier map

GRID_RES_DEG  = 0.10     # ~BR-DWGD/IMERG native resolution (0.1°)
