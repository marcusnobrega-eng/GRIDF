# 02_imerg_v06_annual_max_brazil_native.py
# ---------------------------------------------------------
# Purpose:
#   For each year, compute the maximum daily precipitation
#   from IMERG V06 over Brazil, and export one GeoTIFF to Drive.
#
# Dataset:
#   NASA/GPM_L3/IMERG_V06
#
# Band:
#   precipitationCal, mm/hour
#
# Method:
#   IMERG V06 is half-hourly in GEE.
...
OUT_DRIVE_FOLDER = 'IMERG_V06_Max'

FNAME_PREFIX = 'IMERG_V06_MaxDaily_0p10deg_{year}_Brazil'
...
IMERG_COLLECTION_ID = 'NASA/GPM_L3/IMERG_V06'
IMERG_BAND = 'precipitationCal'
# --------------------------------------------


def make_daily_imerg_total(imerg_collection, date, brazil_geom):
    """
    Converts one day of IMERG V06 half-hourly precipitation rate to daily total.

    precipitationCal is treated as mm/hour.
...
def main():
    ...
    print(f"Exporting IMERG V06 annual maxima for years: {years[0]}–{years[-1]}")
    ...
    print("\nAll yearly IMERG V06 exports submitted.")
